  ...
  @extends('layouts.app2')
    ...
    @section('content')
      <main>
        <section class="py-5 text-center container-fluid" id="section1">
          ...
          <div class="row">
            <div class="col md-3">
              <h5 class="text-success fw-bold" id="tittle">Pharmacien Chef de Pôle</h5>
            ...
            <div class="col md-3">
              <h5 class="text-success fw-bold" id="tittle">Responsable de site</h5>
              <h6>Sylvie DJOUSSA</h6>
            </div>
            <div class="col md-3">
              <h5 class="text-success fw-bold" id="tittle">Encadrement du personnel non médical</h5>
            ...
            <div class="col md-3">
              <h5 class="text-success fw-bold" id="tittle">Direction de pôle</h5>
                  ...
                  @foreach ($pharmaciens as $pharmacien)
                    <div class="col">
                      <div class="card shadow-sm">
                        <img src="{{asset('pharmacien/'.$pharmacien->photo)}}" alt="photo de profil" >
                          <div class="card-body">
                            <h4 class="text-success">{{$pharmacien->nom}}</h4>
